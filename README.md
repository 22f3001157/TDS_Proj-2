...
```bash
git clone https://github.com/22f3001157/TDS_Proj-2.git
cd tds-geniesolver
```
...
**Author**: Ashutosh Chand
**Course**: Tools in Data Science (TDS)
**Institution**: IIT Madras

For questions or issues, please open an issue on the [GitHub repository](https://github.com/22f3001157/TDS_Proj-2).